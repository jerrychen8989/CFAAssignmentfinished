...
namespace AssignmentSolution.Tests
{
    [TestClass]
    public class CalculatorUnitTest
    {
        ...
        {
            string puzzle = "{}";
            int outcome = assignmentService.CalculateScore(puzzle);
        ...
        {
            string puzzle = "{{<a!>},{<a!>},{<a!>},{<ab>}}";
            int outcome = assignmentService.CalculateScore(puzzle);
            Assert.AreEqual(outcome, 3);
        ...
        public void CalculatorTest6()
        {
            string puzzle = "{{}{}}";
            int outcome = assignmentService.CalculateScore(puzzle);
            Assert.AreEqual(outcome, 5);

        }
        [TestMethod]
        public void CalculatorTest7()
        {
            string puzzle = "{<a>,<a>,<a>,<a>}";
            int outcome = assignmentService.CalculateScore(puzzle);
            Assert.AreEqual(outcome, 1);
        ...
        {
            string puzzle = "{{<ab>},{<ab>},{<ab>},{<ab>}}";
            int outcome = assignmentService.CalculateScore(puzzle);
            Assert.AreEqual(outcome, 9);
